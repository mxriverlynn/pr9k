...
8. **Final CI check** (sonnet)
9. **Update docs** (sonnet)
10. **Deferred work** — files any new issues from `deferred.txt`
11. **Lessons learned** — codifies entries from `progress.txt`
12. **Final git push**
